...
```bash
git clone https://github.com/fisch0920/dotfiles.git && cd dotfiles && git submodule init && git submodule update && source bootstrap.sh
```

To update, `cd` into your local `dotfiles` repository and then:

```bash
git submodule update && source bootstrap.sh
```
